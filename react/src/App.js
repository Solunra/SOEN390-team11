        ...
        <>
            {loggedIn?<>
                <IdleTimer
                    ...
                    debounce={250}
                />
                <Dialog open={open} aria-labelledby="form-dialog-title" classes={ classes.dialogWrapper } fullWidth>
                    <DialogTitle id="form-dialog-title">You have been idled for 30 minute</DialogTitle>
                    <DialogContent >
                        <DialogContentText> Do you want to stay or log out, if you do not choose in 10 seconds, it would automatically log out</DialogContentText>
                    </DialogContent>
                    <DialogActions classes={{ root: classes.leftDialogActions }}>
                        <Button onClick={keepLogin} color="primary">Keep LogIn</Button>
